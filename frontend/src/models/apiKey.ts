 ...
 *（抄自 deepseek-harness ui-settings-models/apiKey.ts）
 */

/**
 * Twin of `normalizeApiKey` in the harness llm package: printable ASCII, space
 * excluded. The charset rule is mirrored here rather than imported; keep the
 * two in step.
 */
