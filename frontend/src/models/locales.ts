/** Copy dictionaries for the Models settings section（抄自 deepseek-harness ui-settings-models）。 */
...
export const en = {
  ...
  customRouteHint: "A unique name that identifies this provider in the model picker.",
  ...
  customApiOpenai: "OpenAI-compatible",
  customNeedsBaseUrl: "A custom provider needs a base URL.",
  customNeedsModels: "A custom provider needs at least one model.",
  create: "Create provider",
  creating: "Creating…",
  keyRequired: "Enter an API key to continue.",
  advancedHint: "Other fields live in the provider's own configuration; edit that section directly.",
...
/** Chinese strings (same keys as en). */
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  customApi: "API 协议",
  customApiOpenai: "OpenAI 兼容",
  customNeedsBaseUrl: "自定义提供方需要填写 API 地址。",
  customNeedsModels: "自定义提供方至少需要一个模型。",
  create: "创建提供方",
  creating: "创建中…",
  keyRequired: "请输入 API 密钥后继续。",
  advancedHint: "其余字段在提供方自身的配置中，请直接编辑对应段。",
...
export const t = (key: ModelsKey): string => zh[key];
